...
| 국가      | 최대 생산량 (PA) | 30클릭당 PA | 특수 능력                                |
| :---------- | :--------- | :----------- | :--------------------------------------------- |
| **스페인**   | 100        | 2 PA     | 자원이 풍부한 국가                           |
| **네덜란드** | 90         | 3 PA       | 기술이 발전한 국가                           |
| **영국**    | 60         | 2 PA     | 절대왕정: 부가가치 무조건 승리                  |
| **프랑스**  | 60         | 2 PA     | 중상주의: 성공적인 무역/투자 시 +5 PA 보너스 |

### 게임 단계별 규칙

1.  **생산 단계**
    - 플레이어는 클릭하여 재화(PA)를 생산합니다. (기본: 30회 클릭당 2 PA, 네덜란드: 30회 클릭당 3 PA)
    - 각 팀은 라운드가 +1 될 때 마다 생산 기회를 +2 획득합니다.
...
2.  **출항 단계**
    - 팀은 출항 목적지를 선택합니다:
        ...
        - **인도:** 후추 획득 기회
        - **출항 안함:** 해당 라운드 휴식
    - 출항에는 최소 20 PA가 필요하며, 10 PA 단위로만 투자할 수 있습니다.

3.  **투자 단계**
    - 다른 팀의 항해에 10 PA 단위로 투자할 수 있습니다.
    - 무역에 성공하면 투자자는 투자금에 비례하여 무역품을 분배받습니다.
        - **순풍:** 10 PA당 무역품 1개
        - **무역풍:** 10 PA당 무역품 2개
    - 투자 원금은 입항 시 즉시 반환됩니다.

4.  **입항 단계**
    - 무역 결과는 아래 두 가지 요소에 의해 결정됩니다:
        1.  **이벤트 카드 (무작위 추첨):**
            - **무역풍 (5%):** 획득 무역품 2배, 항해비 보전
            - **해적왕 조우 (20%):** 무역품 모두 상실, 항해비 보전
            - **순풍 (75%):** 기본 보상 (변동 없음), 항해비 보전
        2.  **입항 가위바위보:**
            - **승리:** 무역품 +1개
            - **무승부:** 무역품 +0개
            - **패배:** 무역품 -1개
...
- **희소성 보너스:** 게임 종료 시, 전체 수량이 더 적은 무역품의 가치가 20% 증가합니다.
- **독점 보너스:** 특정 무역품을 50% 이상 보유한 팀은 게임 종료 시 20 PA 보너스를 받습니다.
